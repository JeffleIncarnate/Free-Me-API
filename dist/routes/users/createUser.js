...
router.post("/createUserNoAuth", (0, express_fileupload_1.default)(), (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    let banner;
    let profilePicture;
    ...
    const user = {
        ...
        password: yield (0, argon2_1.hashPassword)(req.body.password),
...
router.post("/createUserVerifyEmail", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b;
    if (req.body.type !== "consultant" &&
        req.body.type !== "client" &&
        req.body.type !== "freerider")
    ...
    const user = {
        ...
        gst: req.body.gst,
        socials: {
            facebook: (_a = req.body.facebook) !== null && _a !== void 0 ? _a : null,
            linkedIn: (_b = req.body.linkedIn) !== null && _b !== void 0 ? _b : null,
        },
        scopes: {
            getSelf: false,
            mofifySelf: false,
...
router.post("/createUserFromToken", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
