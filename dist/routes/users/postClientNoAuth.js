...
router.post("/postClientNoAuth", (0, express_fileupload_1.default)(), (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    let banner;
    let profilePicture;
    ...
    const user = {
        ...
        profile: {
            ...
            companyHistory: JSON.parse(req.body.companyHistory),
        },
    };
    let query = {
...
//# sourceMappingURL=postClientNoAuth.js.map